        ...
        <div className="col-xs-12 col-md-12 card-container">
            <div className="card">
                <div className="card-block">
                    <span className="card-title">{`${props.data.itemname[0].toUpperCase()}${props.data.itemname.slice(1)}`}</span>
                    <br/>
                    <StarRatingComponent
                     name="ono-rating" 
                        starCount={5}
            ...
            <button onClick={e => props.addToCart(props.data)}>ADD TO CART</button>
        </div>
    );
};
